...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        openDatabase("maindatabase.db");                     //connect to our database file, when you stop the server the connection to the database
        ...
        Server server = new Server(7269);                   // prepare our Jetty Server to listen on port 8081
